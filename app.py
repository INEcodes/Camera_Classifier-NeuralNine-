...
class App:
    ...
    def init_gui(self):
        ...
        self.btn_class_one = tk.Buttton(self.window, text=self.classname_one, width = 50, command=lambda: self.save_for_class(1))
        ...
        self.btn_reset = tk.Button(self.window, text="Reset", width=50, command=self.rest)
    ...
    def save_for_class(self,class_num):
        ...
        img.thumgnail((150,150), PIL.Image.ANTIALIAS)
    ...
    def update(self):
        ...
        if ret:
            self.photo = PIL.ImageTk.PhotoImage(image = PIL.IMage.formarray(frame))
